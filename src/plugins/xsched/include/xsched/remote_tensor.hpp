...
/**
 * @brief XSCHED plugin remote tensor which wraps memory from the vector
 */
...
public:
    ...
    static void type_check(const Tensor& tensor) {
        RemoteTensor::type_check(
            tensor,
            {{ov::device::full_name.name(), {"XSCHED"}}, {"vector_data_ptr", {}}, {"vector_data", {}}});
    }
